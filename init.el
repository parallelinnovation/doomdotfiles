...
;; setting the key bindings for org-roam
...
(global-set-key (kbd "C-c n x") 'org-id-get-create)

;; setting th key binding to insert current time
...
(setq fancy-splash-image "~/.doom.d/emacs-logo-vim.png")
